    ...
    <div className="py-12">
      <div className="container-custom">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span>/</span>
          <Link href="/products/smart-toilet" className="hover:text-primary-main">Smart Toilets</Link>
          <span>/</span>
        ...
        <div className="mb-12">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <p className="mb-4">
              The {product.modelName} is designed for easy installation in most bathrooms. 
              Standard installation typically takes 1-2 hours by a professional plumber.
            </p>
            <h3 className="font-bold mb-2">Requirements:</h3>
            <ul className="list-disc pl-5 mb-4">
              <li>Standard water supply connection</li>
              <li>Standard electrical outlet (GFCI protected)</li>
              <li>Minimum floor space: {product.specs.dimensions}</li>
            </ul>
            <Button variant="outline">Download Installation Manual</Button>
          </div>
        </div>
      </div>
    </div>
