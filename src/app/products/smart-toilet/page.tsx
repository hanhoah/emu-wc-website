...
export default function SmartToiletPage() {
  const products = getProductsByCategory('smart-toilet');
  ...
  return (
    <div className="py-12">
      <div className="container-custom">
        ...
        <h1 className="text-4xl font-bold mb-6">Smart Toilets</h1>
        <p className="text-lg text-gray-600 mb-8">
          Our complete smart toilet solutions offer advanced features for the ultimate bathroom experience.
          Each model combines comfort, hygiene, and innovative technology.
        </p>
